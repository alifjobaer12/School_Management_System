...
class admin_panel:
    ...
    def std_find(self):
        def std_find_result():
            ...
            header_label = CTkLabel(find_std_result_frame, text="Found", fg_color="transparent", width=1, height=1, font=("Helvetica",12, "bold"))
            ...
            if self.delete == 1:
                e_s_delete_btn = CTkButton(find_std_result_frame, text="Delete", command=self.std_add, font=("Helvetica",14, "bold"), hover=True)
            ...
            if self.fees == 1:
                ...
                update_btn = CTkButton(update_fees_frame, text="Update", command=self.std_add, font=("Helvetica",14, "bold"), hover=True)
